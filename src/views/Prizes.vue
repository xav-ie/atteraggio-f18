    ...
    <b-container fluid>
      ...
      <b-row>
        ...
        <b-col sm="10" md="4" style="border-top: 1px solid grey; border-bottom: 1px solid grey;">
          ...
          <p class="info">
              Winning idea will be awarded a Spark! Fellowship to continue work on their project through a semester-long spark! fellowship. 
              Participants must be enrolled in Boston University and able to attend workshops on Mondays from 3:30-6:30pm 
              (through and a design sprint February 9th and 10th 11-5pm. For more information: <a href="http://www.bu.edu/spark/students/spark-programs/#innovation-fellows">Spark Fellowship</a>
          </p>
        </b-col>
        ...
        <b-col sm="10" md="3">
          ...
          <p class="prizeItem"> $250 for the team </p>
          <p class="info"> Students need to help colleges reduce waste on campus. Right now, this is done by weighing trash. We can do better! We want your ideas on how to do this better. A few problems we are trying to solve are:<br>
              
               &#8226; How to better classify the composition of trash (think computer vision models)<br>
                &#8226; How to best track the waste generated by each individual student (think: app that incentivizes photo uploads so we can also build a trash classifier while attributing trash to each student)<br>
                &#8226; How to retrofit existing trash cans to collect data on trash composition or to guide users on which trash can to use e.g. bottle vs. orange vs. paper (think: hardware)<br>
            
              We are open to any cool ideas you have beyond the above, it can be just for a student’s dorm room, for the dining room, or industrial purposes. </p>
        </b-col>
      </b-row>
      <b-row>
        <b-col md="1" />
