    ...
    <b-container fluid>
      ...
      <b-row>
        ...
        <b-col sm="10" md="4" style="border-top: 1px solid grey; border-bottom: 1px solid grey;">
          <p class="category"> Spark! Track your Trash Challenge</p>
          <p class="prizeItem"> $500 Visa Gift Card</p>
          <p class="info">
             Students need to help colleges reduce waste on campus. Right now, this is done by weighing trash. We can do better! We want your ideas on how to do this better. A few problems we are trying to solve are:<br>
              ...
              We are open to any cool ideas you have beyond the above, it can be just for a student’s dorm room, for the dining room, or industrial purposes. 
          </p>
        </b-col>
      </b-row>
      <b-row>
